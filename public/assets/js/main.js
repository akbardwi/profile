    ...
    $(function () {
        ...
        $('#contact-form').on('submit', function (e) {
            if (! e.isDefaultPrevented()) {
                ...
                $('#contact-form').find('.messages').html('<div class="alert alert-warning" alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Sedang mengirim pesan, mohon tunggu sebentar.</div>')
                $.ajax({
                    type: "POST",
                    url: url,
                    data: $(this).serialize(),
                    success: function (data) {
                        ...
                        $('.txt_profile_token').val(data.token);
                    }
                });
                return false;
            }
