    ...
    <div class="ajax-page-wrapper">
        <div class="ajax-page-nav">
            <div class="nav-item ajax-page-prev-next">
                <a class="ajax-page-load" href="sifarmasi.html"><i class="pe-7s-icon pe-7s-angle-left"></i></a>
                <a class="ajax-page-load" href="semnasti.html"><i class="pe-7s-icon pe-7s-angle-right"></i></a>
            </div>
        ...
        <div class="row">
            <div class="col-sm-7 col-md-7 portfolio-block">
                <div class="owl-carousel portfolio-page-carousel">
                    ...
                    <div class="item">
                        <img src="https://storage.cloud.google.com/newtaskbucket/portfolio/hitech/2.png" alt="">
                    </div>
                    <div class="item">
                        <img src="https://storage.cloud.google.com/newtaskbucket/portfolio/hitech/3.png" alt="">
                    </div>
                </div>
            ...
            <div class="col-sm-5 col-md-5 portfolio-block">
                ...
                <ul class="project-general-info">
                    ...
                    <li><p><i class="fa fa-calendar"></i> 26 Maret 2021</p></li>
                </ul>

                <p class="text-justify">Hi Technology (Hi Tech) merupakan acara tahunan yang diselenggarakan oleh Himpunan Mahasiswa Teknik Informatika (HMTI) Universitas Dian Nuswantoro. Sistem backend dari website ini menggunakan CodeIgniter 4</p>
                <!-- /Project Description -->
